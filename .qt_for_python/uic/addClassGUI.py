...
"font-size: 16pt;")
        ...
        self.courseLink = QtWidgets.QLineEdit(Dialog)
        self.courseLink.setGeometry(QtCore.QRect(170, 240, 531, 61))
        self.courseLink.setStyleSheet("color: rgb(255, 255, 255)")
        self.courseLink.setObjectName("courseLink")
